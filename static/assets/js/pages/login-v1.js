$(function() {
    if($('body').data('page') == 'login'){
        ...
        $.backstretch(["static/assets/images/gallery/login.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["static/assets/images/gallery/login4.jpg", "static/assets/images/gallery/login3.jpg", "static/assets/images/gallery/login2.jpg", "static/assets/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
